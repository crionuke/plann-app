...
class IncomeMonthPanelView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final IncomeMonthPanelBloc bloc =
        Provider.of<IncomeMonthPanelBloc>(context, listen: false);
    ...
    return SingleChildScrollView(
        ...
        child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              var state = snapshot.data as IncomeMonthPanelViewState;
